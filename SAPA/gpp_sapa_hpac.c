...
static GPPLONG gpp_sapa_hpac_header2buffer(const pGPP_SAPA_HPAC p_hpac,GPPUCHAR *buffer, GPPLONG *byte_pos, GPPLONG *bit_pos)
{
	...
	GPPUINT1 time_tag_type = p_hpac->header_block->time_tag_type;
...
static GPPLONG gpp_sapa_hpac_tropo_poly_coefficient_block2buffer(const pGPP_SAPA_HPAC p_hpac,GPPUINT1 area, GPPUCHAR *buffer, GPPLONG *byte_pos, GPPLONG *bit_pos)
{
	...
	gn_add_val_double_to_buffer(buffer, byte_pos, bit_pos, SAPA_TROPO_COEFF[TROPO_POLY_COEFF_INDX_T00][coeff_size], tpcb->tropo_poly_coeff[TROPO_POLY_COEFF_INDX_T00], SAPA_RES_TROPO_POLY_COEFF_T00);	//SF045orSF048
	if (equ_type != 0)
	{
		gn_add_val_double_to_buffer(buffer, byte_pos, bit_pos, SAPA_TROPO_COEFF[TROPO_POLY_COEFF_INDX_T01][coeff_size], tpcb->tropo_poly_coeff[TROPO_POLY_COEFF_INDX_T01], SAPA_RES_TROPO_POLY_COEFF_T01);	//SF046orSF049
		gn_add_val_double_to_buffer(buffer, byte_pos, bit_pos, SAPA_TROPO_COEFF[TROPO_POLY_COEFF_INDX_T10][coeff_size], tpcb->tropo_poly_coeff[TROPO_POLY_COEFF_INDX_T10], SAPA_RES_TROPO_POLY_COEFF_T01);	//SF046orSF049
	}
	if (equ_type == 2)
	{
		gn_add_val_double_to_buffer(buffer, byte_pos, bit_pos, SAPA_TROPO_COEFF[TROPO_POLY_COEFF_INDX_T11][coeff_size], tpcb->tropo_poly_coeff[TROPO_POLY_COEFF_INDX_T11], SAPA_RES_TROPO_POLY_COEFF_T11);	//SF047orSF050
	}
	return 0;
...
static GPPLONG gpp_sapa_hpac_buffer2tropo_poly_coefficient_block(pGPP_SAPA_HPAC p_hpac, GPPUINT1 area,const GPPUCHAR *buffer, GPPLONG *byte_pos, GPPLONG *bit_pos)
{
	...
	GPPUINT1 coeff_size = tropo_poly_coeff_block.tropo_coeff_size;
	tropo_poly_coeff_block.tropo_poly_coeff[TROPO_POLY_COEFF_INDX_T00]=gn_get_val_double_from_buffer(buffer, byte_pos, bit_pos, SAPA_TROPO_COEFF[TROPO_POLY_COEFF_INDX_T00][coeff_size], SAPA_RES_TROPO_POLY_COEFF_T00);	//SF045orSF048
	if (tropo_poly_coeff_block.tropo_equation_type != 0)
	{
		tropo_poly_coeff_block.tropo_poly_coeff[TROPO_POLY_COEFF_INDX_T01]=gn_get_val_double_from_buffer(buffer, byte_pos, bit_pos, SAPA_TROPO_COEFF[TROPO_POLY_COEFF_INDX_T01][coeff_size], SAPA_RES_TROPO_POLY_COEFF_T01);	//SF046orSF049
		tropo_poly_coeff_block.tropo_poly_coeff[TROPO_POLY_COEFF_INDX_T10]= gn_get_val_double_from_buffer(buffer, byte_pos, bit_pos, SAPA_TROPO_COEFF[TROPO_POLY_COEFF_INDX_T10][coeff_size], SAPA_RES_TROPO_POLY_COEFF_T01);	//SF046orSF049
	}
	if (tropo_poly_coeff_block.tropo_equation_type == 2)
	{
		tropo_poly_coeff_block.tropo_poly_coeff[TROPO_POLY_COEFF_INDX_T11]= gn_get_val_double_from_buffer(buffer, byte_pos, bit_pos, SAPA_TROPO_COEFF[TROPO_POLY_COEFF_INDX_T11][coeff_size], SAPA_RES_TROPO_POLY_COEFF_T11);	//SF047orSF050
	}
...
static GPPLONG gpp_sapa_hpac_iono_sat_coeff2buffer(const pGPP_SAPA_HPAC p_hpac, GPPUINT1 sys, GPPUINT1 sat, GPPUINT1 area, GPPUCHAR *buffer, GPPLONG *byte_pos, GPPLONG *bit_pos)
{
	...
	gn_add_val_double_to_buffer(buffer, byte_pos, bit_pos, SAPA_IONO_COEFF[IONO_POLY_COEFF_INDX_C00][coeff_size], tpcb->iono_poly_coeff[IONO_POLY_COEFF_INDX_C00], SAPA_RES_IONO_POLY_COEFF_C00);	//SF057orSF060
	if (equ_type != 0)
	{
		gn_add_val_double_to_buffer(buffer, byte_pos, bit_pos, SAPA_IONO_COEFF[IONO_POLY_COEFF_INDX_C01][coeff_size], tpcb->iono_poly_coeff[IONO_POLY_COEFF_INDX_C01], SAPA_RES_IONO_POLY_COEFF_C01);	//SF058orSF061
		gn_add_val_double_to_buffer(buffer, byte_pos, bit_pos, SAPA_IONO_COEFF[IONO_POLY_COEFF_INDX_C10][coeff_size], tpcb->iono_poly_coeff[IONO_POLY_COEFF_INDX_C10], SAPA_RES_IONO_POLY_COEFF_C01);	//SF058orSF061
	}
	if (equ_type == 2)
	{
		gn_add_val_double_to_buffer(buffer, byte_pos, bit_pos, SAPA_IONO_COEFF[IONO_POLY_COEFF_INDX_C11][coeff_size], tpcb->iono_poly_coeff[IONO_POLY_COEFF_INDX_C11], SAPA_RES_IONO_POLY_COEFF_C11);	//SF059orSF062
	}
	return 0;
...
static GPPLONG gpp_sapa_hpac_buffer2iono_sat_coeff(pGPP_SAPA_HPAC p_hpac,GPPUINT1 sys, GPPUINT1 sat, GPPUINT1 area,const GPPUCHAR *buffer, GPPLONG *byte_pos, GPPLONG *bit_pos)
{
	...
	iono_sat_coeff.iono_poly_coeff[IONO_POLY_COEFF_INDX_C00]=gn_get_val_double_from_buffer(buffer, byte_pos, bit_pos, SAPA_IONO_COEFF[IONO_POLY_COEFF_INDX_C00][coeff_size], SAPA_RES_IONO_POLY_COEFF_C00);	//SF057orSF060
	if (equ_type != 0)
	{
		iono_sat_coeff.iono_poly_coeff[IONO_POLY_COEFF_INDX_C01]=gn_get_val_double_from_buffer(buffer, byte_pos, bit_pos, SAPA_IONO_COEFF[IONO_POLY_COEFF_INDX_C01][coeff_size], SAPA_RES_IONO_POLY_COEFF_C01);	//SF058orSF061
		iono_sat_coeff.iono_poly_coeff[IONO_POLY_COEFF_INDX_C10]=gn_get_val_double_from_buffer(buffer, byte_pos, bit_pos, SAPA_IONO_COEFF[IONO_POLY_COEFF_INDX_C10][coeff_size], SAPA_RES_IONO_POLY_COEFF_C01);	//SF058orSF061
	}
	if (equ_type == 2)
	{
		iono_sat_coeff.iono_poly_coeff[IONO_POLY_COEFF_INDX_C11]=gn_get_val_double_from_buffer(buffer, byte_pos, bit_pos, SAPA_IONO_COEFF[IONO_POLY_COEFF_INDX_C11][coeff_size], SAPA_RES_IONO_POLY_COEFF_C11);	//SF059orSF062
	}
