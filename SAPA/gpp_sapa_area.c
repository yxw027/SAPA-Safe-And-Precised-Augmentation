...
static GPPLONG gpp_sapa_area_buffer2header(pGPP_SAPA_AREA p_area, GPPUINT1 *no_of_areas, GPPUCHAR *buffer, GPPLONG *byte_pos, GPPLONG *bit_pos);
static GPPLONG gpp_sapa_area_buffer2area(const pGPP_SAPA_AREA p_area, GPPUINT1 area, GPPUCHAR *buffer, GPPLONG *byte_pos, GPPLONG *bit_pos);
/**************************************************************************
